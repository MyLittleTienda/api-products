INSERT INTO `mlt-products`.product (id, name, description, deleted_at)
...
INSERT INTO `mlt-products`.category (id, name)
VALUES (1, 'Cuadernos');
INSERT INTO `mlt-products`.category (id, name)
VALUES (2, 'Sublimados');
INSERT INTO `mlt-products`.category (id, name)
...
INSERT INTO `mlt-products`.product_category (product_id, category_id)
VALUES (1, 1);
INSERT INTO `mlt-products`.product_category (product_id, category_id)
VALUES (1, 3);
INSERT INTO `mlt-products`.product_category (product_id, category_id)
...
INSERT INTO `mlt-products`.price (product_id, price, deleted_at)
VALUES (1, 500, null);
INSERT INTO `mlt-products`.price (product_id, price, deleted_at)
VALUES (1, 1500, null);
INSERT INTO `mlt-products`.price (product_id, price, deleted_at)
...
INSERT INTO `mlt-products`.product_image (product_id, image_link, provider, deleted_at)
